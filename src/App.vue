...
import { useTodoStore } from './stores/todo_store.js';
import { ref } from 'vue';
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <router-link class="navbar-brand" to="/"><img class="logo" src="../public/note_logo.png" alt="" />MyNote</router-link>
